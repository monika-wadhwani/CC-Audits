...
class AuditAlertBoxController extends Controller
{
    ...
    {
        $data = AuditAlertBox::where('company_id',Auth::user()->company_id)->get();
        return view('porter_design.audit_alert_box.list',compact('data'));
    }
    ...
    {
        return view('porter_design.audit_alert_box.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('porter_design.audit_alert_box.edit',compact('data'));
