...
{   
    ...
    public function test_html_new_get(Request $request) {
       ...
       /*  echo $end_date;
        ...
        if(Auth::user()->id == 42 || Auth::user()->id == 172 ||  Auth::user()->id == 284 || Auth::user()->id == 198 || Auth::user()->id == 267 ) {
            $client_id=9;
       ...
       ; */
        ...
        if(Auth::user()->id == 252 || Auth::user()->id == 269 || Auth::user()->id == 279 || Auth::user()->id == 283) {
            ...
            $audit_data = Audit::where('client_id',$client_id)
       			   ->whereIn('partner_id',array(38,39,43,45,53))
			       ->where('process_id',$process_id)
			       ->whereDate('audit_date',">=",$start_date)
			       ->whereDate('audit_date',"<=",$end_date)
			       ->whereHas('raw_data', function (Builder $query) use ($location_id,$lob) {
        ...
        dd(); */
            ...
            {   
                ...
                elseif(Auth::user()->id == 42 || Auth::user()->id == 172 ||  Auth::user()->id == 284 || Auth::user()->id == 198) {
    ...
    {   
        ...
        if(Auth::user()->is_first_time_user == 1) {
            ...
            if(Auth::user()->id == 42 || Auth::user()->id == 172 ||  Auth::user()->id == 284 || Auth::user()->id == 198 || Auth::user()->id == 41) {
    ...
    public function welcome_dashboard_new(Request $request)
    {
        ...
        // starts rebuttal 
          $rebuttal_data = [];
           ...
           elseif(Auth::user()->id == 252 || Auth::user()->id == 269 || Auth::user()->id == 270 || Auth::user()->id == 271 || Auth::user()->id == 279) {
            $audit_data = Audit::with('raw_data')->where('client_id',$client_id)
                           ->whereDate('audit_date','>=',$month_first_data)
                           ->whereDate('audit_date','<=',$today)->whereIn('process_id',[21,22,40])->get();
            $callType=RawData::select(DB::raw("distinct(call_type)"))->where('client_id',$client_id)->whereIn('partner_id',[38,39,43,45,53])->whereIn('process_id',[21,22,40])->orderby('id','asc')->get();
           ...
           elseif(Auth::user()->id == 252 || Auth::user()->id == 269 || Auth::user()->id == 270 || Auth::user()->id == 271 || Auth::user()->id == 279 || Auth::user()->id == 283)  {
            $temp_rebuttal_data = Audit::where('client_id',$client_id)->whereIn('process_id',[21,22,40])->where('rebuttal_status','>',0)->whereDate('audit_date','>=',$month_first_data)->whereDate('audit_date','<=',$today)
             ->withCount(['audit_rebuttal','audit_rebuttal_accepted'])->get();
         }
         elseif(Auth::user()->id == 307 || Auth::user()->id == 308)  {
...
$process_audit_data['audit_count'] = Audit::where('client_id',$client_id)
    ...
    public function get_rdr_client_list()
    {
        ...
        {
            if(Auth::user()->id == 42 || Auth::user()->id == 172 ||  Auth::user()->id == 284 || Auth::user()->id == 198 || Auth::user()->id == 279 || Auth::user()->id == 256
             || Auth::user()->id == 251) {
            	
            	$list=[9=>'TATA AIA'];
            } else {
                if(Auth::user()->client_detail) {
                    $list=[Auth::user()->client_detail->client_id=>Auth::user()->client_detail->client->name];
                    
                    
                    
                   // $list=[$client_id=>Auth::user()->client_detail->name];
                } else {
                    $client_id = Auth::user()->parent_client;
                    if($client_id == 0) {
        ...
        {   
            if(Auth::user()->id == 139 || Auth::user()->id == 195 || Auth::user()->id == 256) {
                $list = [9=>'TATA AIA'];
            }
    ...
    public function get_rdr_client_partner_list($client_id)
    {
        ...
        }else
        {
            ...
            elseif(Auth::user()->id == 252 || Auth::user()->id == 139 || Auth::user()->id == 269 || Auth::user()->id == 279) {
                $list=Partner::where('id',38)->orWhere('id',39)->orWhere('id',43)->orWhere('id',45)->orWhere('id',53)->pluck('name','id');
            } elseif(Auth::user()->id == 270 || Auth::user()->id == 271 || Auth::user()->id == 280) {
    ...
    public function rebuttal_status_report(Request $request)
    {
        ...
        elseif(Auth::user()->id == 252 || Auth::user()->id == 269 || Auth::user()->id == 279) {
             $temp_all_lob = RawData::select(DB::raw("distinct lob as lob"))->where('partner_id',38)->orWhere('partner_id',39)->orWhere('partner_id',43)->orWhere('partner_id',45)->orWhere('partner_id',53)->get()->toArray();
        }
        elseif(Auth::user()->id == 270 || Auth::user()->id == 271 || Auth::user()->id == 280) {
...
/*         print_r($temp_all_lob);
    ...
    public function new_parameter_compliance_report(Request $request) {
        ...
        if( Auth::user()->hasRole('partner-quality-head') ){          
            ...
            if(Auth::user()->id == 253 || Auth::user()->id == 250 || Auth::user()->id == 252 ||
                Auth::user()->id == 269 || Auth::user()->id == 255 || Auth::user()->id == 246 || Auth::user()->id == 139 || Auth::user()->id == 195 || Auth::user()->id == 254 || Auth::user()->id == 42 || Auth::user()->id == 172 ||  Auth::user()->id == 284 || Auth::user()->id == 198 || Auth::user()->id == 270 || Auth::user()->id == 271 || 
    ...
    public function get_partner_lob($partner_id)
    {
        ...
        if($partner_id == 'all'){
            ...
            else if(Auth::user()->id == 42 || Auth::user()->id == 172 ||  Auth::user()->id == 284 || Auth::user()->id == 198){
    ...
    public function get_partner_audit_cycle($partner_id)
    {
       // $temp_all_lob = RawData::select(DB::raw("distinct lob as lob"))->where('partner_id',$partner_id)->get()->toArray();
        //echo "<pre>";
        //print_r($temp_all_lob); die;
        if(Auth::user()->id == 253 || Auth::user()->id == 255 || Auth::user()->id == 250 || Auth::user()->id == 246 || Auth::user()->id == 139 || Auth::user()->id == 195 || Auth::user()->id == 254 || Auth::user()->id == 42 || Auth::user()->id == 172 ||  Auth::user()->id == 284 || Auth::user()->id == 198 || Auth::user()->id == 267 || Auth::user()->id == 274 ) {
            $client_id=9;
        } else {
            //$client_id=1;
            if(Auth::user()->id == 85){
        ...
        $html.='<option value="2021-04-01,2022-03-31">Current Financial Year</option>';
