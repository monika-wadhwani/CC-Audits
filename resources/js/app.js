...
Vue.component('porter-audit', require('./components/PorterAuditComponent.vue').default);
...
Vue.component('qc-sub-parameter-updater-feedback', require('./components/QcSubParameterUpdaterFeedback.vue').default);
...
Vue.component('qtl-dashboard', require('./components/QtlDashboard.vue').default);
