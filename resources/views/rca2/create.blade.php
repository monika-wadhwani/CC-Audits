                  ...
                  <input type="hidden" name="company_id" value="{{Auth::User()->company_id}}">
									...
									<div class="kt-portlet__body">
										<div class="kt-form__section kt-form__section--first">
											...
											<div class="form-group row">
												<label class="col-lg-2 col-form-label">RCA2 data file:</label>
												<div class="col-lg-4">
													<input type="file" name="rca2_data_file" class="form-control"/>
												</div>
											</div>
											<a href="/rca_data.xlsx" download="download">Click to download example RCA2 data file format, please same structure before upload.</a>
