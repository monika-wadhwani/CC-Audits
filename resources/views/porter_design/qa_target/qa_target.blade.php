...
<div class="container-fluid">
    <div class="titlTops cardBox my-2 d-flex justify-content-between align-items-center">
        <div class="">
            <h3 class="fw-bold mb-1 boxTittle">QA Target</h3>
        </div>
        <a href="/qa_target/list"><button type="btn" class="btn btn-primary px-4"> <i class="bi bi-arrow-left pe-2"></i>
                Back</button></a>
    </div>
    {!! Form::open(
    array(
    ...
    <small><a href="/qa_target_sample_moth.xlsx" download="download">Click here to donwload sample file. (* Date
            format:- yyyy-mm-dd)</a></small>
</div>
