...
<div class="titlTops cardBox my-2 d-flex justify-content-between align-items-center">
        <div class="">
            <h3 class="fw-bold mb-1 boxTittle">Language Master</h3>
        </div>
        <a href="/language"><button type="btn" class="btn btn-primary px-4"> <i class="bi bi-arrow-left pe-2"></i>
                Back</button></a>
    </div>
    <div class="cardBox my-2 px-3">
        ...
        {!! Form::model($data,
                  array(
                  'method' => 'PATCH',
                    'url' =>'language/'.Crypt::encrypt($data->id),
                    'class' => 'kt-form',
