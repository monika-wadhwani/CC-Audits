...
<div class="container-fluid">
    <div class="titlTops cardBox my-2 d-flex justify-content-between align-items-center">
        ...
        <a href="/cluster"><button type="btn" class="btn btn-primary px-4"> <i class="bi bi-arrow-left pe-2"></i>
                Back</button></a>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                {!! Form::model($data,
                    array(
                    'method' => 'PATCH',
                      'url' =>'cluster/'.Crypt::encrypt($data->id),
                      'class' => 'kt-form',
                        ...
                        <div id="kt_repeater_1">
                            <div class="form-group  row" id="kt_repeater_1">
                                ...
                                <div data-repeater-list="circle" class="col-lg-10">
                                    @foreach($data->circle as $kk=>$vv)
                                        <div data-repeater-item class="form-group row align-items-center">
                                            <input type="hidden" name="row" value="{{$vv->id}}">
                                            <div class="col-md-7">
                                                <div class="kt-form__group--inline">
                                                    ...
                                                    <div class="kt-form__control">
                                                        <input type="text" value="{{$vv->name}}" class="form-control" name="name">
                                                    </div>
                                                </div>
                                                <div class="kt-form__group--inline">
                                                    <div class="kt-form__label">
                                                    ...
                                                    <div class="kt-form__control">
                                                        <input type="text" value="{{$vv->detail}}" class="form-control" name="detail">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div data-repeater-delete="" class="btn-sm btn btn-danger btn-pill" @click="onCircleDelete({{$vv->id}})" >
                                                    <span>
