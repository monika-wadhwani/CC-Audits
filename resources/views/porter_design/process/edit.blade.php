...
<div class="titlTops cardBox my-2 d-flex justify-content-between align-items-center">
        <div class="">
            <h3 class="fw-bold mb-1 boxTittle">Process Master</h3>
        </div>
        <a href="/process"><button type="btn" class="btn btn-primary px-4"> <i class="bi bi-arrow-left pe-2"></i>
                Back</button></a>
    </div>
    <div class="cardBox my-2 px-3">
        <div class="row">
            ...
            {!! Form::model($data,
                  array(
                  'method' => 'PATCH',
                    'url' =>'process/'.Crypt::encrypt($data->id),
                    'class' => 'kt-form',
        ...
        <input type="hidden" name="company_id" value="{{Auth::User()->company_id}}">
                <div class=" mainTbl pe-1">
                    <div class="form-contentMet">
                        ...
                        <input type="number" name="auditor_estimation_time" value="{{($data->audit_estimation_time_in_secs)/60}}" class="form-control">
                        </div>
                    </div>
                    <div class="form-contentMet">
                    <div class="mb-3 w-100">
                        <label for="exampleFormControlTextarea1" class="form-label">Details</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3">{{$data->details}}</textarea>
                        </div>
                    </div>
