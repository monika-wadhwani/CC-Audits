...
<div class="container-fluid">
    <div class="titlTops cardBox my-2">
        <h4 class="fw-bold mb-1 boxTittle">Audit Alert Box</h4>

    </div>
    <div class="tblM w-100 boxShaow px-3">
        <div class="titleBtm p-2">
            <h5 class="m-0 fs-14">Messages</h5>
            ...
            <table class="table mb-0 datatables">
				...
				<tr>
					...
					<td nowrap>
                        ...
                        <a href="{{url('audit_alert_box/'.Crypt::encrypt($row->id).'/edit')}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit">
