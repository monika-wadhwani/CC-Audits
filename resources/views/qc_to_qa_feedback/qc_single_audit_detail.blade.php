...
@section('main')
						                  ...
						                  <input type="hidden" name="audit_id" value="{{Crypt::encrypt($audit_data->id)}}">
											<div class="form-group row">
												<div class="col-lg-4">
													...
													<input type="text" name="call_id" class="form-control" value="{{$raw_data->call_id}}" readonly>
												</div>
												<div class="col-lg-4">
													<label>Client:</label>
											...
											<div class="form-group row">
												<div class="col-lg-4">
													...
													<input type="text" class="form-control" value="{{$raw_data->disposition}}" name="disposition" readonly>
												</div>
												<div class="col-lg-4">
													<label>Customer Name*:</label>
													<input type="text" class="form-control" name="customer_name" readonly  value="{{$raw_data->customer_name}}" required>
												</div>
												<div class="col-lg-4">
													<label>Cusotmer contact number*:</label>
													<input type="text" class="form-control" name="phone_number" readonly  value="{{$raw_data->phone_number}}" required>
												</div>
											</div>
											<div class="form-group row">
												<div class="col-lg-4">
											...
											<div class="form-group row">
												<div class="col-lg-4">
													...
													<input type="text" class="form-control" readonly value="{{$raw_data->call_time}}" name="call_time">
												</div>
												<div class="col-lg-4">
													<label>Call Duration:</label>
													<input type="text" class="form-control" readonly value="{{$raw_data->call_duration}}" name="call_duration">
												</div>
												<div class="col-lg-4">
													<label>Refrence Number:</label>
													<input type="text" class="form-control" readonly value="{{$audit_data->refrence_number}}" name="refrence_number">
												</div>
											</div>
											...
											<div class="form-group row">
												<div class="col-lg-4">
													...
													<input type="text" class="form-control" name="language_2" required  value="{{$audit_data->language_2}}" readonly>
												</div>
												<div class="col-lg-4">
											...
											<div class="form-group row">
												<div class="col-lg-4">
													<label>Case ID*:</label>
													<input type="text" class="form-control" readonly name="case_id" value="{{$audit_data->case_id}}" required>
												</div>
												<div class="col-lg-4">
													<label>Overall Call Summary*:</label>
													<textarea class="form-control" readonly name="overall_summary" required>{{$audit_data->overall_summary}}</textarea>
												</div>
												<div class="col-lg-4">
													<label>Feedback to Agent*:</label>
													<textarea class="form-control" readonly name="feedback">{{$audit_data->feedback}}</textarea>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-md-10 kt-font-bolder">
													<div class="row">
														...
														<div class="col-md-1 kt-font-bolder">Check Feedback</div>
													</div>
												</div>
											</div>
												...
												<div class="col-md-10 sp-row">
													...
													<div class="row flex-container" >
														...
														<div class="col-md-1">
															...
															<qc-sub-parameter-updater-feedback audit-id="{{$audit_data->id}}"
																					  parameter-id="{{$value['id']}}"
																					  sub-parameter-id="{{$svalue['id']}}"
																					  rebuttal-id="0">
														    </qc-sub-parameter-updater-feedback>
        ...
        <div class="kt-portlet__body">
		  ...
		  <div class="form-group">
			@if($audit_data->qc_feedback_file)
			<a href="https://qmtool.qdegrees.com/storage/screenshot/{{$audit_data->qc_feedback_file}}">Download Artifact Link</a>
			@else
				Artifcat not attached
			@endif
        ...
        <div class="kt-portlet__foot">
          <div class="kt-form__actions">
<!--             <button type="submit" class="btn btn-primary">Read and Achknoledge</button>
            <button type="reset" class="btn btn-secondary">Not Accepted/Disagree</button> -->
          </div>
        </div>
      </form>
